document.addEventListener('DOMContentLoaded', function () {
    const buttondarkmodeJS = document.getElementById("buttondarkmode");
    const themeSystem = localStorage.getItem("themeSystem") || "light";

    buttondarkmodeJS.addEventListener('click', () => {
    ...
    function defineCurrentTheme(theme) {
        ...
        if (theme == "light") {
            buttondarkmodeJS.innerHTML = darkSvg;
        } else {
            buttondarkmodeJS.innerHTML = lightSvg;
        }
    }
